    ...
    IServiceProvider applicationServices)
{
    ...
    private static Task WriteJsonRpcErrorAsync(
        ...
        int errorCode = -32000)
    {
        JsonRpcError content = new JsonRpcError()
        {
        ...
        return StreamableHttpHandler.WriteJsonResponseAsync(context.Response, statusCode, (object) content);
    }
        ...
        object content)
    {
        ...
        await JsonSerializer.SerializeAsync<object>(response.Body, content);
    ...
    {
        context.Response.Headers.ContentType = (StringValues) "text/event-stream";
        context.Response.Headers.CacheControl = (StringValues) "no-cache,no-store";
        context.Response.Headers.ContentEncoding = (StringValues) "identity";
